...
describe('User End-to-End Tests', () => {
  ...
  describe('POST /usuarios', () => {
    ...
    it('debería lanzar un error si los datos del usuario son inválidos', async () => {
      const invalidUser = {
        nombre: 'Usuario de Prueba',
        // Falta el campo de email y password
      };
      ...
      expect(response.body).toHaveProperty('error', 'Debe proporcionar un correo electronico');
    });
  });
  ...
  describe('GET /usuarios/:id', () => {
    ...
    it('debería lanzar un error si el usuario no es el dueño de la cuenta', async () => {
      ...
      expect(response.body).toHaveProperty('error', 'Usted no es el dueño de esta cuenta, no la puede ver');
    });
  });
